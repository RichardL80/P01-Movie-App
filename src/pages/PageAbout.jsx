    ...
    <main>
      <section>
        <article className='about-container'>
          <div>
            <h3>About the Movie App</h3>
            <div>
              <p>The <span className='card-title'>Movie App</span> is a one-stop shop for movies.</p>
        ...
        <article className='about-container'>
          <div>
            ...
            <div>
              ...
              <img src="/P01-Movie-App/images/TMDB-logo.svg" alt="TMDB logo" className='logo-small clickable' 
